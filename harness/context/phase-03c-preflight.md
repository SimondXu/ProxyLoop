...
- Integration baseline at activation: `main` = `763a1a9` (Phase 07A). The
  branch `feat/phase-03c-stage0-rebaseline` was stacked on
  `chore/docs-progress-sync` (`524c69b`, PR #31) because the 03C contract and
  handoff were in that docs PR; after #30 and #31 merged the commit was
  cherry-picked unchanged onto `main` (`120e102`) as
  `feat/phase-03c-stage0-rebaseline-v2`.
