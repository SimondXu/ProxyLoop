...
This module is the single authority for offer compliance reason codes and
for the bounded set of Provider ``applied_changes`` an agent may accept.
``proxyloop_telecom_domain`` re-exports it; every oracle, environment, and
executor call site consumes it from here.
"""
