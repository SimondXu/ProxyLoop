...
class ScriptedLLM:
    ...
    def _record(
        self, request: TextRequest | ToolRequest, response: str | None, start: int
    ) -> LLMCallRecord:
    ...
    def _next(self, request: TextRequest | ToolRequest) -> tuple[str, int]:
