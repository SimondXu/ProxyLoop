...
REQUIRED_PATHS = (
    ...
    "harness/log/phase-05a-temporal-case-workflow.md",
    ...
    "harness/build/phase-05a-temporal-case-workflow.md",
    ...
    "harness/context/phase-05a-preflight.md",
    "harness/code_review",
    ...
    "harness/code_review/phase-05a-temporal-case-workflow.md",
    ...
    "runtime/packages/case_runtime/pyproject.toml",
    "runtime/packages/case_runtime/src/proxyloop_case_runtime/py.typed",
    "runtime/services/api/pyproject.toml",
    "runtime/services/api/src/proxyloop_api/server.py",
    "runtime/services/workflow_worker/pyproject.toml",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/activities.py",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/client.py",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/config.py",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/models.py",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/py.typed",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/readiness.py",
    "runtime/services/workflow_worker/src/proxyloop_workflow_worker/worker.py",
