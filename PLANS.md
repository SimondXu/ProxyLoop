...
| 01B | Simulator breadth and benchmark gate | Integration pending | `harness/build/phase-01b-simulator-benchmark.md` |
...
Current approved phase objective:
...
Phase 01B is the only active implementation phase. Phase 02 data-factory and trajectory work is not authorized and requires a new explicit user gate.
